...
// calculate the average of the Movies: hint: we already have a function that
// does 
...
const orderByYear = (movies) => {
    ...
    //spread operator
    return [...orderedMovies]; //Spread operator -> ... spread the item of the array into another array
}
...
// if you are ordering numbers -> .sort( <functioninside> )
// if you are ordering numbers -> .sort( <functioninside> )
